...
<body class="page-service">
  ...
  <div class="container">
    <div class="row">
      <div class="service-title">Biology Tutoring</div>
    </div>
      ...
      <div class="col-sm-6 col-md-3 col-md-push-1">
          <form>
            <div class="form-group">
              ...
              <select class="form-control type" service="biology" id="type">
                <option value="0">Select Type</option>
                <option value="school">School</option>
                <option value="college">College</option>
                <option value="ap-biology" no-specifics>AP Biology</option>
              </select>
              <div>
