...
<body class="page-service">
  ...
  <div class="container">
    <div class="service-title">Practice</div>
    <div class="row">
                ...
                <form>
                    <div class="form-group">
                        <div class="vertical-positioning">
                            <label for="vehicle"><h3 class="tg-inline-blk content-title">Practice type</h3></label>
            ...
            <div class="service-inner-wrapper">
                ...
                <div class="inner-content-container">
                    <form>
                        <div class="form-group">
                            <div class="vertical-positioning">
                                <label for="vehicle"><h3 class="tg-inline-blk content-title">Experience</h3></label>
                                <select class="form-control vehicle-type">
                            ...
                            <div class="vertical-positioning">
                                ...
                                <select class="form-control vehicle-type">
                                    ...
                                    <option value="1.0-hours">1.0 Hour</option>
